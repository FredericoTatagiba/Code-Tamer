...
const EVOLUTIONS = {
  ...
  'Magnaangemon':    { xpToEvolve: 800, evolvesTo: ['Seraphimon', 'Valkyrimon', 'Shinegreymon', 'Marineangemon'] },
  ...
  'Knightmon':       { xpToEvolve: 800, evolvesTo: ['Gallantmon', 'Valkyrimon'] },
  'Ladydevimon':     { xpToEvolve: 800, evolvesTo: ['Lilithmon', 'Kuzuhamon','Beelstarmon'] },
  ...
  'Parrotmon':       { xpToEvolve: 800, evolvesTo: ['Metalgarurumon', 'Phoenixmon', 'Gryphonmon', 'Crossmon'] },
  ...
  'Rizegreymon':     { xpToEvolve: 800, evolvesTo: ['Shinegreymon', 'Slayerdramon', 'Victorygreymon'] },
  ...
  'Skullmeramon':    { xpToEvolve: 800, evolvesTo: ['Beelzebumon'] },
  ...
  'Vademon':         { xpToEvolve: 800, evolvesTo: ['Hiandromon', 'Herculeskabuterimon'] },
  ...
  'Myotismon':       { xpToEvolve: 800, evolvesTo: ['Piedmon', 'Venommyotismon', 'Jijimon'] },
  'Antylamon':       { xpToEvolve: 800, evolvesTo: ['Dianamon', 'Ophanimon', 'Cherubimon'] },
  'Wargrowlmon':     { xpToEvolve: 800, evolvesTo: ['Gallantmon', 'Shinegreymon'] },
